...
HD_PWD='D:/HSD_SNU_2021/my_ip/lab03_0319/lab03_0319.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_add.tcl
