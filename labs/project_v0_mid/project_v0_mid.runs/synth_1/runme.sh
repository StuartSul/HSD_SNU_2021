...
HD_PWD='D:/HSD_SNU_2021/labs/project_v0_mid/project_v0_mid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_pe_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_pe_array.tcl
