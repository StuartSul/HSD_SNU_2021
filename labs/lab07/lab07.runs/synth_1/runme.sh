...
HD_PWD='D:/HSD_SNU_2021/labs/lab07/lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sec_checker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sec_checker.tcl
