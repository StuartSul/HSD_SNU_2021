...
HD_PWD='D:/HSD_SNU_2021/labs/lab07/lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sec_checker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sec_checker.tcl -notrace
