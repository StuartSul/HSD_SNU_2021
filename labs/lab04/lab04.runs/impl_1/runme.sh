...
HD_PWD='D:/HSD_SNU_2021/labs/lab04/lab04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_MAC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source floating_point_MAC.tcl -notrace
