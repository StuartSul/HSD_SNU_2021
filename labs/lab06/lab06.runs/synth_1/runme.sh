...
HD_PWD='D:/HSD_SNU_2021/labs/lab06/lab06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_pe_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_pe_controller.tcl
