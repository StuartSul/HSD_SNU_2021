...
HD_PWD='D:/HSD_SNU_2021/labs/lab06/lab06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_pe_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_pe_controller.tcl -notrace
